...
bs = 16 # It's the batch size. How many images are loaded per batch during training. # Lo he cambiado de 64 a 32 para ver si así funcionaba

image_side = 512 # ESTO ES IMPORTANTE, Dentro de Letters192 por ejemplo hay algunas imagenes de un tamaño superior a 192x192 pero al hacer esto lo ponemos bien!!
